 ...
 * @author SRO_SUK
 */
public class SalesReportOrderType extends javax.swing.JFrame {
String repDateFrom,repDateTo;
 Connection conn = null;
    /**
     * Creates new form SalesReport
     */
    public SalesReportOrderType() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabelSalesReport.setText("Sales Report by Order Type");
        ...
        txtDateFrom.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N

        jLabel2.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        jLabel2.setText("To");

        txtDateTo.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        ...
        jComboBoxOrderType.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        jComboBoxOrderType.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Dine In", "TakeAway" }));
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addComponent(jComboBoxOrderType, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)))
...
//this.setIconImage(icon);
    ...
    private void btnViewActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnViewActionPerformed
     ...
     private void printSalesReport() {
         ...
         setReportDateFormat();
        String jrxmlFile = "\\ePOS\\src\\main\\java\\com\\pos\\menu\\reports\\SalesReportOrderType.jrxml";
      
        HashMap param = new HashMap();
        param.put("dateFrom", repDateFrom);
        param.put("dateTo",repDateTo);
        param.put("p_order_type", this.jComboBoxOrderType.getSelectedItem().toString());
  ...
  private void setReportDateFormat()
  {
   ...
   try {
        ...
        Logger.getLogger(SalesReportOrderType.class.getName()).log(Level.SEVERE, null, ex);
    }
  }
    /**
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SalesReportOrderType.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
